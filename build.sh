...
c_filenames="src/main.c"

compiler_flags="-Wall -Wextra -Wpedantic -Wstrict-aliasing=3 -Wwrite-strings -Wvla -Wcast-align=strict -Wstrict-prototypes -Wstringop-overflow=4 -Wno-missing-braces -O0 -std=c11"
include_flags="-Isrc"
